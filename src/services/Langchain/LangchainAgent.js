...
function invokeLLM(prompt) {
    return __awaiter(this, void 0, void 0, function () {
        var response, chunks, _a, response_1, response_1_1, chunk, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, llm.stream(prompt)];
                case 1:
                    response = _e.sent();
                    chunks = [];
                    _e.label = 2;
                ...
                case 13:
                    // Once the response is received, you can use it
...
invokeLLM("best basketball player ever");
